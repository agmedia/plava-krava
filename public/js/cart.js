                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.gift_email,
                      expression: "gift_email"
                    }
                  ],
                  staticClass: "form-control",
                  attrs: {
                    type: "text",
                    placeholder: "Upišite poklon bon email..."
                  },
                  domProps: { value: _vm.gift_email },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.gift_email = $event.target.value
                    }
                  }
                })
              ])
              ...
              _c("div", { staticClass: "form-group" }, [
                _c("div", { staticClass: "input-group" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: { type: "text", placeholder: "Imate Kupon kod?" },
                                  ...
                                  [
                                    _c(
                                      ...
                                      [
                                        _c("i", {
                                          staticClass:
                                            "ci-book fs-lg opacity-60 mt-n1 me-2"
                                        }),
